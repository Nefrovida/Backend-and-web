...
const LabResultComponent: FC<Props> = ({ patientResult }) => {
  ...
  return (
    <Link
      className="rounded-lg drop-shadow-md shadow-md border-2 border-light-blue flex bg-white items-center justify-between py-2 px-4 hover:shadow-xl text-lg"
    ...
    >
      ...
      <div className="text-3xl">{Status[patientResult.analysis_status]}</div>
    </Link>
  );
};
