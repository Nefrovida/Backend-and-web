...
import UserListExternal from "../molecules/UserListExternal";
import Empty from "../atoms/Empty";
import UserListAll from "../molecules/UserListAll";
import UserListPending from "../molecules/UserListPending";
...
function PendingUsersPage() {
  ...
  const handleConvertExternal = async (userId: string, userName: string) => {
    ...
    try {
      ...
      setError(err?.message || "Error al convertir usuario externo");
    }
  };
  ...
  const filteredUsers =
    selectedRole === "all"
      ? allUsers
      : allUsers.filter((u) => u.role_id === selectedRole);
